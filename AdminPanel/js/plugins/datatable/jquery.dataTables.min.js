...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Следваща",sPrevious:"Предишна"},sEmptyTable:"No data available in table",sInfo:"Показване от _START_ до _END_ от общо _TOTAL_ записа",sInfoEmpty:"Намерени от 0 до 0 от общо 0 записа",sInfoFiltered:"(филтрирани резултати от общо _MAX_ записа)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Зареждане...",sProcessing:"Търсене...",sSearch:"Търси:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Не са намерени резултати"},oSearch:h.extend({},
